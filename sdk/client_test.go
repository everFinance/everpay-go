...
func TestClient_BundleByHash(t *testing.T) {
	...
	assert.NoError(t, err)
	assert.Equal(t, "0xb375c4b3b1955d993781d5363693824710a7c65cd7d07dac5e3a53d016ec03af", tx.EverHash)
	assert.Equal(t, "0x65093420bd5dbcd4164387a4d8f0781c376bff1c5d41bd151cc91b672e689426", bundle.HashHex())
